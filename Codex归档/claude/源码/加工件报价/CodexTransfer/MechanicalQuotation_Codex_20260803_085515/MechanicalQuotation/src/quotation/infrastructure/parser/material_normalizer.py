...
_MATERIAL_ALIASES: list[tuple[str, list[str]]] = [
    ("A6061-T6", [
        "A6061-T6", "A6061T6", "AL6061-T6", "AL6061T6",
        "6061-T6", "6061T6", "AL6061", "6061",
        "6061鋁", "鋁6061",
    ]),
    ("SUS304", [
    ...
    ("SUS316", [
        "SUS316", "SUS-316", "SUS 316", "316", "316L",
    ]),
    ("S50C", [
        "S50C", "S-50C", "S 50C", "50C", "s50c",
    ]),
    ("SKD11", [
        "SKD11", "SKD-11", "SKD 11",
    ]),
    ...
    ("SPCC", [
        "SPCC", "SPCC-SD", "冷軋鋼板", "冷轧钢板",
    ]),
    ("普通鋼", [
        "普通鋼", "普通钢", "普通", "SS400", "Q235", "A3鋼",
    ]),
    ("鋁型材", [
        "鋁型材", "铝型材", "鋁擠型", "铝挤型",
    ]),
