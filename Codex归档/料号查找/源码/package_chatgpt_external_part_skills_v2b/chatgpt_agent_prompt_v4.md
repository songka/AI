...
- 查找顺序必须中文优先：
  1. 品牌中文官网 / 中国官网 / 台湾官网 / 香港官网的产品页。
  2. 品牌中文官网 PDF、中文目录、中文说明书。
  3. 中文授权代理商、中文经销商、品牌直营网店页面。
  4. 中文工业品平台，例如 米思米、怡合达、震坤行、工品汇、阿里巴巴 1688、京东工业品等。
  5. 淘宝 / 天猫商品页，只作为图片和型号外观补充来源，不能单独作为 confirmed 的官方证据。
  6. 如果中文资料不足，再查英文/日文/其他语言官网或 PDF。
- 图片要求多角度、多张：
  - 每个料号优先找 3-6 张图片。
  - 尽量覆盖 front、side、back、label、connector、catalog。
  - 至少输出 1 张最可信图片；如果找不到多角度，必须在 note 里说明缺少哪些角度。
...
- 官网产品页、官方 PDF、官方目录优先级最高。
- 中文官网或中文官方 PDF 优先于英文普通代理商页面。
- 淘宝/天猫/1688 可以作为图片、外观、型号补充证据，但不能单独作为品牌或产品 confirmed 的唯一证据。
- 若只能找到非官方证据，应降低结论等级。
