...
6. English, Japanese, or other language official product pages/PDFs if Chinese evidence is insufficient.

Prefer Chinese official sources when available. Do not treat Taobao/Tmall as official confirmation unless the shop is clearly the brand's official store and the page context supports it.
