...
handoff/chatgpt/brand_pending/brand_pending_uc3_20260701_0016.csv

只做品牌识别，不要查官网图片。
输出文件名必须是：
handoff/chatgpt/brand_result/brand_result_uc3_20260701_0016.csv
...
- 不允许留空 evidence_url。
- 不允许无证据确认品牌。
- 不要使用 source:、搜索词、本地文件名、Taobao/Tmall 或虚构 URL 作为品牌证据。
