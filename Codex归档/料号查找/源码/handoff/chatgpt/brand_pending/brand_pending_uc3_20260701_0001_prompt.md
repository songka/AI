# 给 ChatGPT Web 智能体的执行说明

请使用 `external-part-brand-id` 处理附件：
`brand_pending_uc3_20260701_0001.csv`

这是基于 `系统物料20260701.tsv` 新索引重新导出的正式批次，不要沿用旧的 `brand_pending_uc3_0001.csv`。

只做品牌识别，不要查官网图片。

输出文件名必须是：
`brand_result_uc3_20260701_0001.csv`
...
处理完成后，把 `brand_result_uc3_20260701_0001.csv` 放回：
